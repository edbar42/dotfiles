...
Panel {
  ...
  // shell.json.
  readonly property int weekStart: Model.normalizedWeekStart(setting("weekStartDay", null), Qt.locale("pt_BR").firstDayOfWeek)
  readonly property string nextWeekStartLabel: Qt.locale("pt_BR").dayName(Model.toggledWeekStart(weekStart), Locale.LongFormat)
      ...
      Flickable {
        ...
        Column {
          ...
          Item {
            ...
            Row {
              ...
              Text {
                id: heroDate
                anchors.verticalCenter: parent.verticalCenter
                text: Qt.locale("pt_BR").toString(root.today, "MMMM d")
                color: heroMouse.containsMouse
                  ? Style.hoverStateColor(root.contentForeground, Color.accent)
                  : root.contentForeground
                font.family: root.contentFontFamily
          ...
          Item {
            ...
            Item {
              ...
              Text {
                ...
                horizontalAlignment: Text.AlignHCenter
                text: Qt.locale("pt_BR").toString(root.viewDate, "MMMM yyyy").toUpperCase()
                color: Qt.darker(root.contentForeground, 1.4)
                font.family: root.contentFontFamily
                font.pixelSize: Style.font.body
                font.letterSpacing: 1
          ...
          Column {
            ...
            Text {
              width: parent.width
              text: Qt.locale("pt_BR").toString(root.selectedDate, "dddd d MMMM").toUpperCase()
              color: Qt.darker(root.contentForeground, 1.4)
              font.family: root.contentFontFamily
              font.pixelSize: Style.font.caption
              font.letterSpacing: 1
          ...
          SettingsView {
            ...
            syncedAt: root.eventDoc && root.eventDoc.syncedAt
              ? Qt.locale("pt_BR").toString(new Date(root.eventDoc.syncedAt), "d MMM HH:mm")
              : ""
